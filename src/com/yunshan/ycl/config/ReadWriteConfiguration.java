...
public class ReadWriteConfiguration extends ReadOnlyConfiguration {
    ...
    public ReadWriteConfiguration(YamlConfiguration cfg, ConfigManager configManager) {
        this((ConfigurationSection) cfg, configManager);
    }
    
    protected ReadWriteConfiguration(ConfigurationSection cfg, ConfigManager configManager) {
        super(cfg);
    ...
    public ReadWriteConfiguration createSection(String path) {
        return new ReadWriteConfiguration(super.config.createSection(path), this.configManager);
    }
